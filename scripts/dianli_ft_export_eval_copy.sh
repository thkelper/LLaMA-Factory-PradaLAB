...
method=neft5_alpha8_Q8L # Quantization 8 Bit Lora
...
NCCL_P2P_DISABLE=1 NCCL_IB_DISABLE=1 deepspeed --include localhost:${gpu_ids} --master_port 29501 src/train_bash.py \
